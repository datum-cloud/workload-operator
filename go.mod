...
// Direct dependencies of the datumctl compute plugin (cmd/datumctl-compute,
// internal/cmd/compute): the plugin SDK, cobra CLI, and the local unikernel
// image build pipeline (buildkit/docker/containerregistry/erofs).
require (
